...
- `doubt-pass` — pre-decision adversarial gate (CLAIM → EXTRACT → DOUBT → RECONCILE → STOP). Fresh-context reviewer, artifact + contract only, 3-cycle cap, explicit "doubt theater" call-out.
